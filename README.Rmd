...
Use scotgov to programmatically download data from statistics.gov.scot.
...
You will need the URI for your dataset. Find this on the statistics.gov.scot web page for your dataset (in the API tab):
